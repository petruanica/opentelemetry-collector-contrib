...
# HELP execution_errors_created Execution errors total
# TYPE execution_errors_created gauge
execution_errors_created{availability_zone="us-east-1c",error_type="generic",instance_id="i-09db9b55e0095612f",instance_name="",instance_type="trn1n.32xlarge",region="us-east-1",runtime_tag="367",subnet_id="subnet-06a7754948e8a000f",ultraserver_id="1"} 1.7083389404380567e+09
# HELP neuron_runtime_memory_used_bytes Runtime memory used bytes
# TYPE neuron_runtime_memory_used_bytes gauge
...
# HELP system_memory_total_bytes System memory total_bytes bytes
# TYPE system_memory_total_bytes gauge
system_memory_total_bytes{availability_zone="us-east-1c",instance_id="i-09db9b55e0095612f",instance_name="",instance_type="trn1n.32xlarge",region="us-east-1",subnet_id="subnet-06a7754948e8a000f",ultraserver_id="1"} 5.32523487232e+011
# HELP neurondevice_hw_ecc_events_total_mem_ecc_corrected Neuron hardware errors
# TYPE neurondevice_hw_ecc_events_total_mem_ecc_corrected gauge
...
hardware_ecc_events_total{availability_zone="us-east-1c",event_type="sram_ecc_uncorrected",instance_id="i-09db9b55e0095612f",instance_name="",instance_type="trn1n.32xlarge",neuron_device_index="7",region="us-east-1",subnet_id="subnet-06a7754948e8a000f",ultraserver_id="1"} 864.0
`

func TestNewNeuronScraperWithUltraServersEndToEnd(t *testing.T) {
	t.Setenv("HOST_NAME", dummyNodeName)
	expectedMetrics := make(map[string]prometheusscraper.ExpectedMetricStruct)
	expectedMetrics["neuroncore_utilization_ratio"] = prometheusscraper.ExpectedMetricStruct{
		MetricValue: 0.1,
	...
	prometheusscraper.TestSimplePrometheusEndToEnd(prometheusscraper.TestSimplePrometheusEndToEndOpts{
		T:                   t,
		Consumer:            consumer,
		DataReturned:        renameMetricWithUltraServers,
		ScraperOpts:         mockedScraperOpts,
		MetricRelabelConfig: GetNeuronMetricRelabelConfigs(mockHostInfoProvider{}),
	})
}
